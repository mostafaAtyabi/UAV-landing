...
output_dir = 'E:\\UNI\\8\\UAV-landing\\images\\capture\\'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

# Process images
for i in range(1, 13):
    img_path = f'E:\\UNI\\8\\UAV-landing\\images\\capture\\{i}.jpg'  # Path to your image
    ...
    output_path = f'E:\\UNI\\8\\UAV-landing\\images\\capture\\{i}_result.jpg'
